...
\begin{center}
  ...
  \vspace{4mm}
  {\large January ..., 2022 (\it{fix the date})\\}
\end{center}
...
\textit{Combine results and findings from your simulations for the classification of linearly non-separable datasets and non-linear function approximation. Answer the questions, quantify the outcomes, discuss your interpretations and summarise key findings as conclusions.}
