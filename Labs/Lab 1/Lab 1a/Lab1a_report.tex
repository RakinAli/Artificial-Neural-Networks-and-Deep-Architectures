...
This assignment was scoped on the delta and perceptron learning rule.\textbf{ For the delta rule we used batch learning and sequential learning and for the delta rule we only used sequential learning.} The limitations were the different learning rate
...
\textbf{Batch versus sequential learning:} Lastly we compared sequential versus batch learning. They converge to the same result however batch makes the changes faster
