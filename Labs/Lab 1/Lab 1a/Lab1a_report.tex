...
This assignment was scoped on the delta and perceptron learning rule.\textbf{ For the delta rule we used batch learning and sequential learning; for perceptron learning rule, we only used sequential learning.} The limitations were the different learning rate
...
\begin{figure}[htb]
    ...
    \begin{subfigure}{0.4\textwidth}
        ...
        \caption{Delta rule with 100 iterations}
        \label{fig:DeltaRule-Batch}
    \end{subfigure}
    \caption{Mean square error comparison of batch learning and sequential learning}
    \label{fig:DeltaRule-NoBias}
\end{figure}
